...
set python_file_path="C:\Users\liang.wq.1\OneDrive - Procter and Gamble\Physical Distribution(PD)\Digital solution\ITC_Scorecard\BatRun_ITCreport_downloader_rev1.py
